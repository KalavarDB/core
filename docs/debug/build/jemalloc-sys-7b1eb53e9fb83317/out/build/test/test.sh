...
for t in $@; do
  ...
  echo "=== ${t} ==="
  if [ -e "/home/runner/work/core/core/./docs/debug/build/jemalloc-sys-7b1eb53e9fb83317/out/jemalloc/${t}.sh" ] ; then
    ...
    enable_fill=1 \
    enable_prof=0 \
    . /home/runner/work/core/core/./docs/debug/build/jemalloc-sys-7b1eb53e9fb83317/out/jemalloc/${t}.sh && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /home/runner/work/core/core/docs/debug/build/jemalloc-sys-7b1eb53e9fb83317/out/jemalloc/ /home/runner/work/core/core/docs/debug/build/jemalloc-sys-7b1eb53e9fb83317/out/build/
  else
    export MALLOC_CONF= && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /home/runner/work/core/core/docs/debug/build/jemalloc-sys-7b1eb53e9fb83317/out/jemalloc/ /home/runner/work/core/core/docs/debug/build/jemalloc-sys-7b1eb53e9fb83317/out/build/
